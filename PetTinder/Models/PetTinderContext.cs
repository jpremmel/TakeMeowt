        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Pet>()
                .HasData(
                    ...
                    new Pet { PetId = 4, Name = "Toad", Species = "Cat", Breed = "Medium-hair Domestic Feline", Age = 7, Gender = "Male", Bio = "Lovebug, Angel, Shy. Favorite things: Snuggles, Gravy, Treats, Feather. Least favorite things: Loud noises, Strangers, Sudden movements, Vacuum.", LookingFor = "", Photo1 = "uploads/toad4/toad-sofia.jpg", Photo2 = "uploads/toad4/IMG_20171219_183621.jpg", Photo3 = "uploads/toad4/IMG_20190727_151423.jpg", Photo4 = "uploads/toad4/IMG_20180205_214524_1.jpg" },

                    new Pet { PetId = 5, Name = "Winston", Species = "Cat", Breed = "Short-hair Domestic Feline", Age = 6, Gender = "Male", Bio = "A fine boi looking for his furrever girl. Favorite things: His blanket, chirping at birds and squirrels, snuggling on your lap, licking his butt. Least favorite things: The vacuum, being picked up, having his nails clipped.", LookingFor = "", Photo1 = "uploads/winston5/winston-mike.jpg", Photo2 = "uploads/winston5/Image from iOS.jpg", Photo3 = "uploads/winston5/Image from iOS (2).jpg", Photo4 = "uploads/winston5/Image from iOS (1).jpg" },
                    ...
                    new Pet { PetId = 15, Name = "Ashford", Species = "Cat", Breed = "Domestic short hair", Age = 6, Gender = "Male", Bio = "Has an adorable moustache. Favorite things: sleeping. Least favorite things: screaming toddlers.", LookingFor = "", Photo1 = "uploads/ashford15/ashford-anita.jpg", Photo2 = "uploads/ashford15/20191026_201344.jpg", Photo3 = "uploads/ashford15/20190809_114702.jpg", Photo4 = "" },
                    ...
                    new Pet { PetId = 18, Name = "Luna", Species = "Dog", Breed = "Mut", Age = 2, Gender = "female", Bio = "Too much excited. Big love. Likes to wear her work vest to feel important.", LookingFor = "durable play mate", Photo1 = "uploads/luna18/20190731_094803.jpg", Photo2 = "uploads/luna18/IMG-20190830-WA0000.jpg", Photo3 = "uploads/luna18/Screenshot_20190709-093242_Snapchat.jpg", Photo4 = "" },

                    new Pet { PetId = 19, Name = "Patches", Species = "Cat", Breed = "Shorthair", Age = 2, Gender = "Female", Bio = "Very sweet but loves murder. Watch your feet!", LookingFor = "A murder pal and snuggles", Photo1 = "uploads/patches19/Image from iOS (3).jpg", Photo2 = "", Photo3 = "", Photo4 = "" }
                );
        }
    }
}